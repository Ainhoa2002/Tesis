...
cable_length_km = 1.0        # Total cable loop length [km]
eta_conv = 0.80              # Converter efficiency [-]
...
print(f"Lifetime energy losses: {E_loss_total:.2f} kWh")
