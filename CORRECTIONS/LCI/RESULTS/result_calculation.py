...
2. For each product system in PRODUCT_SYSTEMS:
   ...
   - Analyze process contributions (upstream analysis)
    - Generate upstream process trees
...
PRODUCT_SYSTEMS = [
    ...
    "4Q_output_control_card",
    "4Q_output_power_card",
    "4Q_power_card",
    "analog_control",
    "cabling",
    "contactor_card",
    "control_backplane_card",
    "digital_control",
    "fan_supervision_card",
    "filter_card",
    "fuse_card",
    "HF_Power_Transformer_PM624929",
    "inverter_power_card",
    "mechanical_components",
    "power_inductor_PM6249",
    "SECTION_Assembly_Processes",
    "SECTION_Cabling",
    "SECTION_Discrete_Semiconductors",
    "SECTION_Electromechanical",
    "SECTION_Hardware",
    "SECTION_IC",
    "SECTION_Magnetics",
    "SECTION_Mechanical_components",
    "SECTION_Modules",
    "SECTION_Passives",
    "SECTION_PCB"
]
...
def process_system(system_name):
    ...
    4. Extracts and saves:
       ...
       - Contribution analysis (which processes cause the impacts)
         - Upstream process tree (hierarchical dependencies)
    ...
    # ========================================================================
    # 5E. GENERATE TREE DIAGRAM (UPSTREAM PROCESS HIERARCHY)
    # ========================================================================
    # Tree diagram shows hierarchical upstream processes and keeps each
    # process instance at its specific position in the supply chain
    #
